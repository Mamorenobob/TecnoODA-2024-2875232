<<<<<<< Updated upstream:View/Taablas1.php
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<head>
    ...
    <style>
        body {
            background-color: #ee0000; /* Color gris claro para el fondo de toda la página */
            background: linear-gradient(to bottom, #33afff, #7BB4E3);
            background-size: cover;
            background-repeat: no-repeat;
            background-position: center;
        ...
        button {
            margin-bottom: 10px;
            padding: 10px 20px;
            background: linear-gradient(to bottom, #dadada, #000000);
            color: rgb(0, 0, 0);
            border: none;
            border-radius: 5px;
            cursor: pointer;
